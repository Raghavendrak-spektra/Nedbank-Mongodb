...
## Options
Option 1 : `{ region: 1, status: 1, createdAt: -1 }`
Option 2 : `{ createdAt: 1, region: 1, status: 1 }`
Option 3 : `{ region: 1, createdAt: 1, status: 1 }`
Option 4 : `{ status: 1 }`
